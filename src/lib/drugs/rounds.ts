...
export const ROUNDS: Round[] = [
  {
    ...
    teach: "Oral ketamine is a sensitive CYP3A4 first-pass victim. Clarithromycin is a strong 3A4 inhibitor. IV/IM mostly skip gut 3A4; the lozenge does not. Put the pair on the desk and flip the route to oral — the map should jump.",
  ...
  },
  {
    ...
    teach: "A 2D6 PM is the perpetrator. Parent DXM (serotonergic) is not converted to dextrorphan (more NMDA). Flip CYP2D6 to poor — the finding should appear without adding a second molecule.",
