...
export const SAMPLE_REGIMENS: SampleRegimen[] = [
  ...
  {
    id: "auvelity-maoi",
    title: "Auvelity + phenelzine",
    blurb: "DXM/bupropion combo × irreversible MAOI — labeled serotonin crisis",
    drugIds: ["dxm-bupropion", "phenelzine"],
    lane: "clinic",
  },
  {
    id: "lybalvi-opioid",
    title: "Lybalvi + oxycodone",
    blurb: "Samidorphan precipitates withdrawal — μ antagonist on an antipsychotic",
    drugIds: ["olanzapine-samidorphan", "oxycodone"],
    lane: "clinic",
  },
  {
  ...
  {
    id: "mavacamten-fluconazole",
    title: "Mavacamten + fluconazole",
    blurb: "Camzyos REMS — 2C19/3A4 victim; desk does not pick the milligram",
    drugIds: ["mavacamten", "fluconazole"],
    lane: "clinic",
  },
  {
    id: "finerenone-clarithro",
    title: "Finerenone + clarithromycin",
    blurb: "Kerendia × strong 3A4 inhibitor — labeled hard stop",
    drugIds: ["finerenone", "clarithromycin"],
    lane: "clinic",
  },
  {
    id: "adagrasib-methadone",
    title: "Adagrasib + methadone",
    blurb: "Strong 3A4 inhibitor KRAS drug × QT opioid stack",
    drugIds: ["adagrasib", "methadone"],
    lane: "clinic",
  },
  {
    id: "fezolinetant-fluvoxamine",
    title: "Fezolinetant + fluvoxamine",
    blurb: "Veozah × strong 1A2 inhibitor — labeled avoid",
    drugIds: ["fezolinetant", "fluvoxamine"],
    lane: "clinic",
  },
  {
    id: "rimegepant-ritonavir",
  ...
  },
  {
    ...
    drugIds: ["acrylfentanyl", "bromazolam"],
    lane: "street",
  },
  {
    id: "odsmt-maoi",
    title: "O-DSMT + phenelzine",
    blurb: "Tramadol metabolite sold alone × MAOI — serotonin + opioid",
    drugIds: ["o-dsmt", "phenelzine"],
    lane: "street",
  },
  {
    id: "mdpv-maoi",
    title: "MDPV + phenelzine",
    blurb: "Pyrovalerone bath salt × irreversible MAOI — pressor crisis",
    drugIds: ["mdpv", "phenelzine"],
    lane: "street",
  },
  {
    id: "2fdck-benzo",
    title: "2-FDCK + alprazolam",
    blurb: "Street ketamine analog × benzo — airway, not a free k-hole",
    drugIds: ["2-fdck", "alprazolam"],
    lane: "street",
  },
  {
    id: "suzetrigine-clarithro",
    title: "Suzetrigine + clarithromycin",
    blurb: "Non-opioid NaV1.8 analgesic × strong 3A4 inhibitor",
