...
//#region node_modules/.nitro/vite/services/ssr/assets/collect-Kfm3R3SL.js
...
var collectLicenses = createServerFn({ method: "POST" }).validator((input) => ({
	...
	const { collectLicenses: run } = await import("./collect.server-BiPq7nzj.mjs");
	return run(data);
});
...
var draftCollected = createServerFn({ method: "POST" }).validator((input) => ({
	...
	const { draftCollected: run } = await import("./collect.server-BiPq7nzj.mjs");
	return run(data);
});
//#endregion
