...
//#region node_modules/.nitro/vite/services/ssr/assets/router-BnEMGaIc.js
...
var styles_default = "/assets/styles-C-bBCPSt.css";
...
var $$splitComponentImporter = () => import("./routes-DBGEiQuY.mjs");
...
var Route = createFileRoute("/api/stripe/webhook")({ server: { handlers: { POST: async ({ request }) => {
	const { handleStripeWebhook } = await import("./stripe.server-BRadgYd4.mjs");
