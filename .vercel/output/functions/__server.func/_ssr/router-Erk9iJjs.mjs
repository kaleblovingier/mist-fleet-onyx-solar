...
//#region node_modules/.nitro/vite/services/ssr/assets/router-Erk9iJjs.js
var router_Erk9iJjs_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-Cgb8zo6L.css";
...
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "CYP450 desk for ketamine, entactogens, psychedelics, and psychiatric regimens — pharmacokinetic collisions and pharmacodynamic synergies."
			},
			{
				name: "theme-color",
				content: "#efece4"
...
var $$splitComponentImporter = () => import("./routes-CVjSetkh.mjs");
...
//#endregion
export { getRouter, router_Erk9iJjs_exports as t };
